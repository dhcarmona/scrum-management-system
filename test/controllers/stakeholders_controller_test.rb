...
class StakeholdersControllerTest < ActionController::TestCase
  ...
  test "should create stakeholder" do
    assert_difference('Stakeholder.count') do
      post :create, stakeholder: { email: @stakeholder.email, expectations: @stakeholder.expectations, interest: @stakeholder.interest, name: @stakeholder.name, phone_number: @stakeholder.phone_number, power: @stakeholder.power, project_id: @stakeholder.project_id }
    end
  ...
  test "should update stakeholder" do
    patch :update, id: @stakeholder, stakeholder: { email: @stakeholder.email, expectations: @stakeholder.expectations, interest: @stakeholder.interest, name: @stakeholder.name, phone_number: @stakeholder.phone_number, power: @stakeholder.power, project_id: @stakeholder.project_id }
    assert_redirected_to stakeholder_path(assigns(:stakeholder))
  end
